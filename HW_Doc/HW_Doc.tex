...
\chapter{RTL}
	...
	\section{Instructions}
		% \begin{landscape}
				...
				Read Stack     & Imm$\leftarrow$SignExt(IR)                & addr$\leftarrow$imm + fp                         & SMAR$\leftarrow$Addr                   & belt $\leftarrow$ Smem{[}SMAR{]}       \\ \arrayrulecolor{gray}\hline
				...
				Write Stack    & Imm$\leftarrow$ SignExt(IR)                & addr$\leftarrow$imm + fp                        & SMAR$\leftarrow$Addr                   & Smem{[}SMAR{]} $\leftarrow$ data       \\ 
							   &                                           & data$\leftarrow$belt{[}b1{]}                     &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Jump           & Imm$\leftarrow$SignExt(IR)                & PC$\leftarrow$PCX1 + imm                         &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Long Jump      &                                           & PC$\leftarrow$PCX1 + belt{[}b1{]}                &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Branch         & IF CONDITION Imm$\leftarrow$SignExt(IR)   & IF COND PC$\leftarrow$PCX1 + imm                 &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Call Pt 1      & Imm$\leftarrow$SignExt(IR)                & PC$\leftarrow$imm                                & SMAR$\leftarrow$SP + 1                 & FP $\leftarrow$ Smem{[}SMAR{]}         \\ 
							   &                                           & Addr$\leftarrow$FP                               &                                        & SP $\leftarrow$ Smem{[}SMAR{]}         \\ \arrayrulecolor{gray}\hline
				Long Call pt 1 &                                           &                                                  &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Call pt 2      &                                           &                                                  &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Return pt 1    &                                           &                                                  &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Return pt 2    &                                           &                                                  &                                        &                                        \\ \arrayrulecolor{gray}\hline
				SAlloc         & Imm1$\leftarrow$IR                        & imm2$\leftarrow$imm                              & sp$\leftarrow$sp + imm2                &                                        \\ \arrayrulecolor{gray}\hline
				Const          & Imm$\leftarrow$SignExt(IR)                & belt$\leftarrow$imm                              &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Upper          & imm$\leftarrow$ir                         & belt$\leftarrow$imm \textless{}\textless 8       &                                        &                                       
				\end{tabular}
		% \end{landscape}
