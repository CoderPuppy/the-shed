...
\chapter{RTL}
	...
	\section{Fetch}
	IMAR $\leftarrow$ PC | PCX1 $\leftarrow$ PC

	IR <- IMem[IMAR]
	\section{Instructions}
		% \begin{landscape}
				\begin{tabular}{l|llll}
							   & \multicolumn{1}{c}{\textbf{X1 Tick 1}}    & \multicolumn{1}{c}{X1 Tick 2}                    & \multicolumn{1}{c}{\textbf{X2 Tick 1}} & \multicolumn{1}{c}{\textbf{X2 Tick 2}} \\ \hline
				ALU            &                                           & Belt$\leftarrow$Belt{[}b1{]} OP Belt{[}b2{]}     &                                        &                                        \\ \arrayrulecolor{gray}\hline
				ALUI           & Imm$\leftarrow$SignExt(IR)                & Belt$\leftarrow$belt{[}b1{]} OP imm              &                                        &                                        \\ \arrayrulecolor{gray}\hline
				ADDC           &                                           & Belt$\leftarrow$belt{[}b1{]} + (carry(b2)?1:0)   &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Load           & Imm$\leftarrow$SignExt(IR)                & addr$\leftarrow$imm + belt{[}b1{]}               & DMAR$\leftarrow$Addr                   & Belt $\leftarrow$ Dmem{[}DMAR{]}       \\ \arrayrulecolor{gray}\hline
				Read Stack     & Imm$\leftarrow$ZeroExt(IR)                & addr$\leftarrow$imm + fp                         & SMAR$\leftarrow$Addr                   & belt $\leftarrow$ Smem{[}SMAR{]}       \\ 
							   &										   & 												  &										   & cmp <- sp - IMM2    					\\ \arrayrulecolor{gray}\hline
				Store          & Imm$\leftarrow$SignExt(IR)                & addr$\leftarrow$imm + belt{[}b1{]}               & DMAR$\leftarrow$Addr                   & Dmem{[}DMAR{]} $\leftarrow$ data       \\ 
							   &                                           & data$\leftarrow$belt{[}b2{]}                     &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Write Stack    & Imm$\leftarrow$ZeroExt(IR)                & addr$\leftarrow$imm + fp                         & SMAR$\leftarrow$Addr                   & Smem{[}SMAR{]} $\leftarrow$ data       \\ 
							   &                                           & data$\leftarrow$belt{[}b1{]}                     &                                        & cmp $\leftarrow$ sp - IMM2             \\ \arrayrulecolor{gray}\hline
				Jump           & Imm$\leftarrow$SignExt(IR)                & PC$\leftarrow$PCX1 + imm                         &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Long Jump      &                                           & PC$\leftarrow$belt{[}b1{]}                &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Branch         & IF CONDITION Imm$\leftarrow$SignExt(IR)   & IF COND PC$\leftarrow$PCX1 + imm                 &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Call Pt 1      & Imm$\leftarrow$SignExt(IR)                & PC$\leftarrow$PCx1 + Imm                         & SMAR$\leftarrow$SP + 1                 & SMem[SMAR]$\leftarrow$RA               \\ 
							   &                                           &                                                  & FP$\leftarrow$SP + 1                   &                                        \\ 
							   &                                           &                                                  & SP$\leftarrow$SP + 1                   &                                        \\ \arrayrulecolor{gray}\hline
				Long Call Pt 1 &                                           & PC$\leftarrow$belt{[}b1{]}                       & SMAR$\leftarrow$SP + 1                 & SMem[SMAR]$\leftarrow$RA               \\ 
							   &                                           &                                                  & FP$\leftarrow$SP + 1                   &                                        \\ 
							   &                                           &                                                  & SP$\leftarrow$SP + 1                   &                                        \\ \arrayrulecolor{gray}\hline
				Call pt 2      & Addr$\leftarrow$FP                        & RA$\leftarrow$PCx1 + 1                           & SMAR$\leftarrow$SP                     & RFP$\leftarrow$ALU2[Addr]              \\ 
				               &                                           &                                                  & SP++                                   & SMem[SMAR]$\leftarrow$RFP              \\ \arrayrulecolor{gray}\hline
				Return pt 1    & pc$\leftarrow$RA                          & addr$\leftarrow$FP - 1                           & SMAR$\leftarrow$ADDR                   & RA$\leftarrow$Smem[SMAR]               \\ \arrayrulecolor{gray}\hline
				Return pt 2    & fp$\leftarrow$rfp                         &                                                  & SMAR$\leftarrow$ADDR                   & RFP$\leftarrow$Smem[SMAR]              \\ 
				               & addr$\leftarrow$FP - 2                    &                                                  & SP$\leftarrow$ADDR                     &                                        \\ \arrayrulecolor{gray}\hline
				AllocA         & Imm1$\leftarrow$ZeroExt(IR)               & imm2$\leftarrow$imm                              & sp$\leftarrow$sp + imm2                &                                        \\ \arrayrulecolor{gray}\hline
				Const          & Imm$\leftarrow$SignExt(IR)                & belt$\leftarrow$imm                              &                                        &                                        \\ \arrayrulecolor{gray}\hline
				Upper          & imm$\leftarrow$ZeroExt(IR)                & belt$\leftarrow$imm \textless{}\textless 8       &                                        &                                       
				\end{tabular}
		% \end{landscape}
		%call:
