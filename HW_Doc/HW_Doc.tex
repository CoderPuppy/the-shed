...
\chapter{Hardware}
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\node[rectangle,minimum width={\myscale * 6cm},anchor=west] (execute1) at (0cm, 0cm) {};
			...
			\node[rectangle,minimum width={\myscale * 6cm},anchor=west] (execute4) at (execute3.east) {};

			\draw [dashed] (execute1.west |- {0cm, 2cm}) to[|] (0cm, \myscale * -47cm);
			\draw [dashed] (execute2.west |- {0cm, 2cm}) to[|] (0cm, \myscale * -47cm);
			\draw [dashed] (execute3.west |- {0cm, 2cm}) to[|] (0cm, \myscale * -47cm);
			\draw [dashed] (execute4.west |- {0cm, 2cm}) to[|] (0cm, \myscale * -47cm);
			\draw [dashed] (execute4.east |- {0cm, 2cm}) to[|] (0cm, \myscale * -47cm);
